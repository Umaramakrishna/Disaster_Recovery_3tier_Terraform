...
module "launch_templates" {
  ...
  key_name           = "Kalyankey"
  ami_id_frontend    = "ami-063520670fd95764e"
  ami_id_backend     = "ami-0cbbcae5d44dcc059"
...
module "ami_backup" {
  ...
  source_amis = {
    frontend = "ami-063520670fd95764e"
    backend  = "ami-0cbbcae5d44dcc059"
  }
}
